...
public class controlCalculadora {
    ...
    private void resta(double memoria, double resultado) {
        this.memoria = resultado + memoria;
    }

    private void multiplicacion(double memoria, double resultado) {
        this.memoria = resultado + memoria;
    }

    private void division(double memoria, double resultado) {
        this.memoria = resultado + memoria;
    }
